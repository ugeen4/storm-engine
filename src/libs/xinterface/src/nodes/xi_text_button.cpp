...
void CXI_TEXTBUTTON::LoadIni(INIFILE *ini1, const char *name1, INIFILE *ini2, const char *name2)
{
    ...
    m_dwPressedFontColor = GetIniARGB(ini1, name1, ini2, name2, "fontColorPressed", ARGB(255, 255, 255, 255));

    // get font color for selected button
    m_dwSelectedFontColor = GetIniARGB(ini1, name1, ini2, name2, "fontColorSelected", ARGB(255, 255, 255, 255));
